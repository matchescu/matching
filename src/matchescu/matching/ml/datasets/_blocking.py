...
from matchescu.matching.ml.datasets import AttributeComparison, PatternEncodedComparison
...
class BlockDataSet:
    ...
    def cross_sources(self) -> "BlockDataSet":
        self.__comparison_data = pl.DataFrame(
            itertools.starmap(self.__sample_factory, self.__engine.candidate_pairs())
        )
        return self
